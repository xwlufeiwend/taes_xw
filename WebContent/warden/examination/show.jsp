...
<body>
	...
	<ul class="pager">
		<s:if test="currPage != 1">
			<li><a href="wardenexam_show.action?currPage=1">首页</a></li>
			<li><a
				href="wardenexam_show.action?currPage=<s:property value="currPage-1"/>">上一页</a></li>
		</s:if>
		<s:if test="currPage != totalPage">
			<li><a
				href="wardenexam_show.action?currPage=<s:property value="currPage+1"/>">下一页</a></li>
			<li><a
				href="wardenexam_show.action?currPage=<s:property value="totalPage"/>">尾页</a></li>
		</s:if>
	</ul>
	</nav>
</body>
