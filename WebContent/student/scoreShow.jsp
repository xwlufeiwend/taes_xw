...
<body>
	...
	<table class="table-bordered col-xs-12">
		...
		<s:iterator value="list" var="s">
			<tr>
				...
				<td><s:date name="#s.examination.startYear" format="yyyy-MM-dd"/></td>
	...
	<ul class="pager">
		<s:if test="currPage != 1">
			<li><a href="student_scoreShow.action?currPage=1">首页</a></li>
			<li><a
				href="student_scoreShow.action?currPage=<s:property value="currPage-1"/>">上一页</a></li>
		</s:if>
		<s:if test="currPage != totalPage">
			<li><a
				href="student_scoreShow.action?currPage=<s:property value="currPage+1"/>">下一页</a></li>
			<li><a
				href="student_scoreShow.action?currPage=<s:property value="totalPage"/>">尾页</a></li>
		</s:if>
	</ul>
	</nav>
</body>
